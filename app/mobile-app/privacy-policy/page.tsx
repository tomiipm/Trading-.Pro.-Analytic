...
export const metadata = {
  title: "Polityka Prywatności Aplikacji Mobilnej - Trading Pro Analytic",
  description: "Polityka prywatności aplikacji mobilnej Trading Pro Analytic - jak zbieramy, wykorzystujemy i chronimy Twoje dane osobowe",
}
          ...
          <CardContent className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <li>
                  <p><strong>Application</strong> refers to Trading ProAnalytics, the software program provided by the Company.</p>
                </li>
                <li>
                  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Trading ProAnalytics.</p>
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
