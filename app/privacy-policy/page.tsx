...
export const metadata = {
  title: "Polityka Prywatności - Trading Pro Analytics",
  description: "Polityka prywatności Trading Pro Analytics - jak zbieramy, wykorzystujemy i chronimy Twoje dane osobowe",
}
          ...
          <CardContent className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Trading Pro Analytic.</li>
            ...
            <section>
              ...
              <h4 className="text-lg font-semibold mt-6 mb-2">Tracking Technologies and Cookies</h4>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies in our <a href="/cookies-policy" className="text-primary hover:underline">Cookies Policy</a>.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              <div className="space-y-4 mt-6">
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <h5 className="font-semibold mb-2">Cookies Policy / Notice Acceptance Cookies</h5>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                For more information about the cookies we use and your choices regarding cookies, please visit our <a href="/cookies-policy" className="text-primary hover:underline">Cookies Policy</a> or the Cookies section of our Privacy Policy.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3">We may share Your personal information in the following situations:</h3>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
